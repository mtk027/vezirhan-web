    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="#" class="d-lg-none">
                <img alt="{{ config('settings.general.title') }}" src="{{ config('settings.theme.logo') }}"
                    class="h-30px" />
            </a>
        </div>
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                            ...
                            <div class="cursor-pointer symbol symbol-30px symbol-md-40px">
                                ...
                                <span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
                                    <span class="symbol-label font-size-h5 font-weight-bold">
                                        {{ General::get_first_letter(Auth::user()->name) }}
                                    </span>
                                </span>
                            </div>
                        </div>
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold py-4 fs-6 w-275px"
                            ...
                            <div class="menu-item px-5">
                                <a target="_blank" href="{{ url('/') }}" class="menu-link px-5">Siteye Git</a>
                            </div>
                            <div class="menu-item px-5">
                                <a href="{{route('dashboard.users.index')}}" class="menu-link px-5">Profilim</a>
                            </div>
                            <div class="menu-item px-5">
